...
export default {
    ...
    '天津市': {
        '天津市': ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '静海区', '宁河区', '蓟州区']
    },
    '河北省': {
        ...
        '邢台市': ['桥东区', '桥西区', '邢台县', '临城县', '内丘县', '柏乡县', '隆尧县', '任县', '南和县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县', '临西县', '南宫市', '沙河市', '经济开发区'],
        '保定市': ['竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涞水县', '阜平县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县', '涿州市', '定州市', '安国市', '高碑店市'],
        '张家口市': ['桥东区', '桥西区', '宣化区', '下花园区', '万全区', '崇礼区', '张北县', '康保县', '沽源县', '尚义县', '蔚县', '阳原县', '怀安县', '涿鹿县', '赤城县', '怀来县'],
    ...
    '浙江省': {
        ...
        '宁波市': ['海曙区', '江北区', '北仑区', '镇海区', '鄞州区', '奉化区', '象山县', '宁海县', '余姚市', '慈溪市', '余姚市'],
    ...
    '安徽省': {
        ...
        '亳州市': ['谯城区', '涡阳县', '蒙城县', '利辛县'],
        '池州市': ['贵池区', '东至县', '石台县', '青阳县'],
        '宣城市': ['宣州区', '郎溪县', '广德市', '泾县', '绩溪县', '旌德县', '宁国市', '广德市']
    },
    '福建省': {
    ...
    '江西省': {
        ...
        '新余市': ['渝水区', '分宜县'],
        '鹰潭市': ['月湖区', '余江区', '贵溪市'],
        '赣州市': ['章贡区', '南康区', '赣县区', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市', '龙南市'],
    ...
    '山东省': {
        ...
        '烟台市': ['芝罘区', '福山区', '牟平区', '莱山区', '蓬莱区', '长岛县', '龙口市', '莱阳市', '莱州市', '招远市', '栖霞市', '海阳市'],
    ...
    '河南省': {
        ...
        '洛阳市': ['老城区', '西工区', '瀍河回族区', '涧西区', '洛龙区', '孟津区', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师市'],
    ...
    '广东省': {
        ...
        '东莞市': ['莞城街道', '石龙镇', '虎门镇', '道滘镇', '厚街镇', '沙田镇', '长安镇', '寮步镇', '大岭山镇', '大朗镇', '黄江镇', '樟木头镇', '凤岗镇', '塘厦镇', '谢岗镇', '清溪镇', '常平镇', '桥头镇', '横沥镇', '东坑镇', '企石镇', '石排镇', '茶山镇', '石碣镇', '高埗镇', '中堂镇', '麻涌镇', '望牛墩镇', '洪梅镇', '道滘镇'],
        '中山市': ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '小榄镇', '古镇镇', '横栏镇', '东升镇', '沙溪镇', '大涌镇', '黄圃镇', '南头镇', '东凤镇', '阜沙镇', '三角镇', '民众镇', '南朗镇', '港口镇', '神湾镇', '板芙镇', '坦洲镇', '三乡镇', '五桂山镇', '中山港街道'],
        '潮州市': ['湘桥区', '潮安区', '饶平县'],
    ...
    '海南省': {
        ...
        '三亚市': ['海棠区', '吉阳区', '天涯区', '崖州区'],
        '三沙市': ['西沙群岛', '中沙群岛', '南沙群岛'],
        '儋州市': ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '王五镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇', '洋浦经济开发区'],
        '省直辖县级行政单位': ['五指山市', '文昌市', '琼海市', '万宁市', '东方市', '定安县', '屯昌县', '澄迈县', '临高县', '白沙黎族自治县', '昌江黎族自治县', '乐东黎族自治县', '陵水黎族自治县', '保亭黎族苗族自治县', '琼中黎族苗族自治县']
    },
    ...
    '四川省': {
        ...
        '德阳市': ['旌阳区', '罗江区', '中江县', '广汉市', '什邡市', '绵竹市', '广汉市'],
    ...
    '云南省': {
        ...
        '德宏傣族景颇族自治州': ['芒市', '梁河县', '盈江县', '陇川县', '瑞丽市', '瑞丽国家重点开发开放试验区'],
    ...
    '青海省': {
        ...
        '海西蒙古族藏族自治州': ['德令哈市', '格尔木市', '茫崖市', '乌兰县', '都兰县', '天峻县', '大柴旦行政委员会']
    },
    '宁夏回族自治区': {
    ...
    '台湾省': {
        ...
        '新北市': ['板桥区', '三重区', '中和区', '永和区', '新庄区', '土城区', '芦洲区', '树林区', '汐止区', '莺歌区', '三峡区', '淡水区', '瑞芳区', '五股区', '金山区', '万里区', '乌来区', '贡寮区', '双溪区', '坪林区'],
        '桃园市': ['中坜区', '平镇区', '龙潭区', '杨梅区', '新屋区', '观音区', '桃园区', '龟山区', '八德区', '大溪区', '复兴区', '芦竹区'],
        '台中市': ['中区', '东区', '南区', '西区', '北区', '西屯区', '南屯区', '北屯区', '丰原区', '东势区', '大甲区', '清水区', '沙鹿区', '梧栖区', '后里区', '神冈区', '潭子区', '大雅区', '新社区', '石冈区', '外埔区', '大安区', '乌日区', '大肚区', '龙井区', '雾峰区', '太平区', '大里区', '和平区'],
        '台南市': ['中西区', '东区', '南区', '北区', '安平区', '安南区', '永康区', '归仁区', '新化区', '左镇区', '玉井区', '楠西区', '南化区', '仁德区', '关庙区', '龙崎区', '官田区', '麻豆区', '佳里区', '西港区', '七股区', '将军区', '学甲区', '北门区', '新营区', '后壁区', '白河区', '东山区', '六甲区', '下营区', '柳营区', '盐水区', '善化区', '大内区', '山上区', '新市', '安定区'],
        '高雄市': ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '大寮区', '鸟松区', '林园区', '仁武区', '大树区', '大社区', '冈山区', '桥头区', '燕巢区', '田寮区', '阿莲区', '路竹区', '湖内区', '茄萣区', '永安区', '弥陀区', '梓官区', '旗山区', '美浓区', '六龟区', '甲仙区', '杉林区', '内门区', '茂林区', '桃源区', '那玛夏区'],
        '基隆市': ['仁爱区', '信义区', '中正区', '中山区', '安乐区', '暖暖区', '七堵区'],
        '新竹市': ['东区', '北区', '香山区'],
        '嘉义市': ['东区', '西区'],
        '新竹县': ['竹北市', '竹东镇', '新埔镇', '关西镇', '峨眉乡', '宝山乡', '五峰乡', '横山乡', '尖石乡', '北埔乡', '芎林乡'],
        '苗栗县': ['苗栗市', '头份市', '竹南镇', '后龙镇', '通霄镇', '苑里镇', '卓兰镇', '大湖乡', '公馆乡', '铜锣乡', '南庄乡', '头屋乡', '三义乡', '西湖乡', '造桥乡', '三湾乡', '狮潭乡', '泰安乡'],
        '彰化县': ['彰化市', '员林市', '和美镇', '鹿港镇', '溪湖镇', '二林镇', '田中镇', '北斗镇', '花坛乡', '芬园乡', '大村乡', '埔盐乡', '埔心乡', '永靖乡', '社头乡', '二水乡', '田尾乡', '埤头乡', '溪州乡', '竹塘乡', '大城乡', '芳苑乡', '线西乡'],
        ...
        '屏东县': ['屏东市', '潮州镇', '东港镇', '恒春镇', '万丹乡', '长治乡', '麟洛乡', '九如乡', '里港乡', '盐埔乡', '高树乡', '万峦乡', '内埔乡', '竹田乡', '新埤乡', '枋寮乡', '新园乡', '崁顶乡', '林边乡', '南州乡', '佳冬乡', '琉球乡', '车城乡', '满州乡', '枋山乡', '雾台乡', '玛家乡', '泰武乡', '来义乡', '春日乡', '狮子乡', '牡丹乡'],
