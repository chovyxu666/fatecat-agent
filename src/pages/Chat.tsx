      ...
      <div className="relative z-10 p-6 bg-black/20 backdrop-blur-sm">
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="w-12 h-12 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-500 rounded-full flex items-center justify-center transition-colors duration-200"
          >
